...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void createUebungs(){
    List<Uebung> tmp = [];
    tmp.add(Uebung("Flachbankdrücken Maschine", widget.flachbankdruecken_Maschine_Beschreibung,'exercises/flachbankdruecken_Maschine.png',"#ac4bb4", "", ""));
    appData.uebungs = tmp;
  }
  ...
  loadAppData() async{
    final prefs = await SharedPreferences.getInstance();
    appData = AppData.fromJson(jsonDecode(prefs.getString("BuBu") ?? "{\"uebungs\":[], \"trainings\":[]}"));
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => onFitness(appData: appData/*[
              CardItem(),
